    ...
    public class HomeController : BaseController
    {
        ...
        public string BuilderNavBar(IEnumerable<TreeItem<ModuleView>> modules)
        {
            ...
            foreach (var moduleView in modules)
            {
                ...
                {
                    sb.Append("<li class=\"\" id=\"" + moduleView.Item.moduleEntity.Id + "\">\r\n");
                    sb.Append("<a href=\"#\" class=\"dropdown-toggle\">\r\n");
                    sb.Append("<i class=\"menu-icon fa " + moduleView.Item.moduleEntity.IconName + "\"></i>\r\n");
                    sb.Append("<span class=\"menu-text\">\r\n");
                    sb.Append("" + moduleView.Item.moduleEntity.Name + "\r\n");
                    sb.Append("</span>\r\n");
                    sb.Append("\r\n");
                ...
                {
                    sb.Append("<li class=\"\" id=\"" + moduleView.Item.moduleEntity.Id + "\">\r\n");
                    sb.Append("<a href=\"" + moduleView.Item.moduleEntity.Url + "\">\r\n");
                    sb.Append("<i class=\"menu-icon fa " + moduleView.Item.moduleEntity.IconName + "\"></i>\r\n");
                    sb.Append("<span class=\"menu-text\"> " + moduleView.Item.moduleEntity.Name + " </span>\r\n");
                    sb.Append("</a>\r\n");
                    sb.Append("\r\n");
                    sb.Append("<b class=\"arrow\"></b>\r\n");
                    sb.Append("</li>\r\n");
        ...
        public ActionResult Navbar()
        {
            ...
            if (CurrentModule != null)
                ViewBag.CurrentNav = CurrentModule.moduleEntity.Id;
            return View();
        }
